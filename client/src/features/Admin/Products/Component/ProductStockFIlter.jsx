        ...
        >
          ...
          <button
            ...
            className={`btn btn-sm rounded-3 px-3 py-2 d-flex align-items-center gap-2 ${
              stockFilter === "all" ? "bg-dark text-white" : "text-secondary"
            }`}
          ...
          <button
            type="button"
            className={`btn btn-sm rounded-3 px-3 py-2 d-flex align-items-center gap-2 ${
              stockFilter === "in" ? "bg-success text-white" : "text-secondary"
            }`}
            onClick={() => handleStockFilter("in")}
          >
            <span
              className={`rounded-circle ${
                stockFilter === "in" ? "bg-white" : "bg-success"
              }`}
              style={{
                width: "7px",
                height: "7px",
          ...
          <button
            type="button"
            className={`btn btn-sm rounded-3 px-3 py-2 d-flex align-items-center gap-2 ${
              stockFilter === "low" ? "bg-warning text-dark" : "text-secondary"
            }`}
            onClick={() => handleStockFilter("low")}
          >
            <span
              className={`rounded-circle ${
                stockFilter === "low" ? "bg-dark" : "bg-warning"
              }`}
              style={{
                width: "7px",
                height: "7px",
          ...
          <button
            type="button"
            className={`btn btn-sm rounded-3 px-3 py-2 d-flex align-items-center gap-2 ${
              stockFilter === "out" ? "bg-danger text-white" : "text-secondary"
            }`}
